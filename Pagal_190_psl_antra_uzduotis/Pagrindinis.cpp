...
int Isdestimas2(int Pirmas_Skaicius_Einantis_i_Dalyvius, Sportininkai Dalyviai[])
{
    ofstream failas_o("U1out.txt");
    return 0;
}
...
int Apkeitimas(int Pirmas_Skaicius_Einantis_i_Dalyvius, Sportininkai Dalyviai[])
{
    ...
    {
        for(int q=0; q<Pirmas_Skaicius_Einantis_i_Dalyvius; q++)
        {
            if(Dalyviai[i].Starto_Numeris==Dalyviai[q].Finisho_Numeris)
            {
                if(Dalyviai[i].Finisho_Numeris>=200)
                {
                    //vyr
                    SwapSumas(Dalyviai[i].finish_h, Dalyviai[q].finish_h);
                    SwapSumas(Dalyviai[i].finish_m, Dalyviai[q].finish_m);
                    SwapSumas(Dalyviai[i].finish_s, Dalyviai[q].finish_s);
                    SwapSumas(Dalyviai[i].pirmas_i, Dalyviai[q].pirmas_i);
                    SwapSumas(Dalyviai[i].antras_i, Dalyviai[q].antras_i);
                    SwapSumas(Dalyviai[i].pirmas_p, Dalyviai[q].pirmas_p);
                    SwapSumas(Dalyviai[i].antras_p, Dalyviai[q].antras_p);
                }
                ...
                /*
                        if(Dalyviai[i].Finisho_Numeris>=200) {
                << Dalyviai[i].finish_h <<" "<< Dalyviai[i].finish_m <<" "<< Dalyviai[i].finish_s <<" "<< Dalyviai[i].pirmas_i <<" "<< Dalyviai[i].antras_i <<" "<< Dalyviai[i].pirmas_p <<" "<< Dalyviai[i].antras_p<<endl;
                }


                Dalyviai[i].finish_h <<" "<< Dalyviai[i].finish_m <<" "<< Dalyviai[i].finish_s <<" "<< Dalyviai[i].pirmas_i <<" "<< Dalyviai[i].pirmas_p<<endl;
                }
                */
            }
        }
...
int Is_fila(int Pirmas_Skaicius_Einantis_i_Dalyvius, Sportininkai Dalyviai[])
{
    ...
    failas_o<<"Merginos"<<endl;
    //Padaryti for loop kurias leistu ismesti meginas cia
    for(int i=0; i<Dalyviai[0].m2; i++)
    {
        if(Dalyviai[i].Finisho_Numeris<=200)
        {
            failas_o<<Dalyviai[i].Starto_Numeris<<" "<<Dalyviai[i].vardas<<" "<<Dalyviai[i].vieta<<" "<<Dalyviai[i].taskai_laikas_h<<" "<<Dalyviai[i].taskai_laikas_m<<" "<<Dalyviai[i].taskai_laikas_s<<endl;

        }
    }
    failas_o<<"Vaikinai"<<endl;
...
//    Apkeitimas(n, Dalyviai);



    Isdestimas2(n, Dalyviai);
